...
pathForTestHam = "./train/train/ham"
pathForTestSpam = "./train/train/spam"
...
stringForHam = "\n\nAccuracy with training dataset for Ham:" + str(getAccuracyForHamDocs())

stringForSpam = "\nAccuracy with training dataset for Spam:" + str(getAccuracyForSpamDocs())
